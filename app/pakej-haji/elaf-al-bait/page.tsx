...
// Data ELAF AL BAIT Package Variants
const elafAlBaitVariants = [
  {
    id: 'ela55',
    name: 'ELA 55',
    makkahOccupancy: '5 ORANG SEBILIK',
    madinahOccupancy: '5 ORANG SEBILIK',
    originalPrice: 'RM55,590',
    p1Price: 'RM52,590',
    discount: 'RM3,000',
...
// ELAF AL BAIT Package Info
const elafAlBaitIncluded = [
  'Penerbangan Awal & Akhir',
  'Sajian citarasa Melayu',
  'Tempoh: +- 40 hari (Tertakluk jadual penerbangan Charter Haji)',
];

const elafAlBaitNotes = ['*PERLU CUKUP REGU'];

// ELAF AL BAIT Hotels
const elafAlBaitHotels = {
  makkah: {
    name: 'ELAF AL BAIT @ SETARAF',
...
export default function ElafAlBaitPage() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-7xl py-8 md:py-12">
        ...
        <Breadcrumb className="mb-6 md:mb-8">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Elaf Al Bait Hotel</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-3xl">
            Pakej Hotel Elaf Al Bait di Makkah menawarkan tempoh penginapan
            ±40 hari dengan pilihan penerbangan Awal & Akhir. Pilihan ini
            memberi ruang kepada jemaah untuk optimumkan masa beribadah. Akses
            mudah ke Masjidil Haram menjimatkan masa dan tenaga, membolehkan
            anda melaksanakan umrah dan tawaf sekerap mungkin. Bimbingan dan
            kuliah berterusan dapat diadakan di dalam bangunan penginapan tanpa
            sekatan. Pilihan ini adalah ideal bagi mereka yang ingin
            memperkayakan diri dengan ilmu. Harga yang ditawarkan adalah
            berpatutan bersesuaian dengan lokasi hotel.
          </p>
        </div>
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="mb-12 md:mb-16">
            ...
            <div className="flex gap-6 md:gap-8 overflow-x-auto pb-4 scroll-smooth snap-x snap-mandatory mt-6 -mx-4 px-4 md:mx-0 md:px-0">
              {elafAlBaitVariants.map((variant) => (
                <div
                  key={variant.id}
        ...
        <Card className="mb-12 md:mb-16 border-orange-200 bg-orange-50">
          ...
          <CardContent>
            <ul className="space-y-2">
              {elafAlBaitNotes.map((note, index) => (
                <li
                  key={index}
        ...
        {/* ELAF AL BAIT Package Included & Important Info */}
        <div className="mb-12 md:mb-16">
          ...
          <Card className="border border-gray-200">
            ...
            <CardContent>
              <ul className="space-y-3">
                {elafAlBaitIncluded.map((item, index) => (
        ...
        {/* ELAF AL BAIT Hotel Details */}
        <div className="mb-12 md:mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">
            Detail Hotel
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <HotelCard hotel={elafAlBaitHotels.makkah} city="MAKKAH" />
            <HotelCard hotel={elafAlBaitHotels.madinah} city="MADINAH" />
          </div>
        </div>

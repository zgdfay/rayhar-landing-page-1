...
// Data MIRA AJYAD Package Variants
const miraAjyadVariants = [
  {
    id: 'mah55',
    name: 'MAH 55',
    makkahOccupancy: '5 ORANG SEBILIK',
    madinahOccupancy: '5 ORANG SEBILIK',
    originalPrice: 'RM51,990',
    p1Price: 'RM48,990',
    discount: 'RM3,000',
...
// MIRA AJYAD Package Info
const miraAjyadIncluded = [
  'Penerbangan Akhir sahaja',
  'Sajian citarasa Melayu',
  'Tempoh: +- 40 hari (Tertakluk jadual penerbangan Charter Haji)',
];

const miraAjyadNotes = ['*PERLU CUKUP REGU'];

// MIRA AJYAD Hotels
const miraAjyadHotels = {
  makkah: {
    name: 'HOTEL MIRA AJYAD @ SETARAF',
    board: 'SAJIAN CITARASA MELAYU',
    distance: '400M± KE DATARAN MASJIDIL HARAM',
    image: '/hotel-mira/1.png',
    detailImages: [
      '/hotel-mira/2.png',
      '/hotel-mira/3.png',
...
export default function MiraAjyadPage() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-7xl py-8 md:py-12">
        ...
        <Breadcrumb className="mb-6 md:mb-8">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Mira Ajyad Hotel</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-3xl">
            Pakej Hotel Mira Ajyad di Makkah menawarkan tempoh penginapan ±40
            hari dengan Penerbangan Akhir sahaja. Pakej ini menawarkan
            keseimbangan antara harga dan jarak. Nikmati jarak yang ideal ke
            Baitullah, di mana setiap detik langkah ke masjid begitu berharga.
            Bimbingan dan kuliah berterusan dapat diadakan di dalam bangunan
            penginapan tanpa sekatan. Pilihan ini adalah ideal bagi mereka yang
            ingin memperkayakan diri dengan ilmu. Harga yang ditawarkan adalah
        ...
        {/* MIRA AJYAD Package Included & Important Info */}
        <div className="mb-12 md:mb-16">
          ...
          <Card className="border border-gray-200">
            ...
            <CardContent>
              <ul className="space-y-3">
                {miraAjyadIncluded.map((item, index) => (
        ...
        {/* MIRA AJYAD Hotel Details */}
        <div className="mb-12 md:mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">
            Detail Hotel
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <HotelCard hotel={miraAjyadHotels.makkah} city="MAKKAH" />
            <HotelCard hotel={miraAjyadHotels.madinah} city="MADINAH" />
          </div>
        </div>

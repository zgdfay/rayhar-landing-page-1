...
// Data ORINSIS Package Variants
const orinsisVariants = [
  {
    id: 'ori55',
    name: 'ORI 55',
...
export default function OrinsisHotelPage() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-7xl py-8 md:py-12">
        ...
        <Breadcrumb className="mb-6 md:mb-8">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Orinsis Hotel</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-3xl">
            Pakej Hotel Oriensis di Mekah menawarkan tempoh penginapan ±40 hari
            dengan Flight Awal & Akhir, memberi ruang masa lebih lapang untuk
            ibadah. Sajian citarasa Melayu (fullboard) yang mesra selera,
            memudahkan keselesaan jemaah sepanjang penginapan. Akses mudah ke
            Masjidil Haram menjimatkan masa dan tenaga, membolehkan anda lebih
            fokus untuk beribadah. Bimbingan yang berterusan kerana
            kuliah-kuliah akan diadakan di dalam bangunan penginapan. Pilihan
            ideal bagi mereka yang mengutamakan tempoh lebih panjang, bimbingan
            berterusan, dan bajet berpatutan.
          </p>
        </div>
        ...
        <div className="mb-12 md:mb-16">
          ...
          {/* ORINSIS Package Variants */}
          <div className="mb-12 md:mb-16">
            <div className="inline-block mb-6 px-4 py-2 bg-red-100 rounded-full">
              <span className="text-red-700 font-semibold text-sm md:text-base">
                ORINSIS
              </span>
            </div>
        ...
        {/* ORINSIS Package Included & Important Info */}
        <div className="mb-12 md:mb-16">
          ...
          <Card className="border border-gray-200">
            ...
            <CardContent>
              <ul className="space-y-3">
                {orinsisIncluded.map((item, index) => (
        ...
        {/* ORINSIS Hotel Details */}
        <div className="mb-12 md:mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">
            Detail Hotel
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <HotelCard hotel={orinsisHotels.makkah} city="MAKKAH" />
            <HotelCard hotel={orinsisHotels.madinah} city="MADINAH" />
          </div>
        </div>
